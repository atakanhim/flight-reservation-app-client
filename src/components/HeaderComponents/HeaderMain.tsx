        ...
        <div className='flex flex-row justify-between items-center border border-black p-3'>
            ...
            <div className='flex-row flex  justify-center items-center gap-2'>
                ...
                <div className='flex flex-row justify-center items-center gap-2'>
                    ...
                    <a className=' cursor-pointer transition-all duration-200 border-b-2 hover:border-purple-950 '>Deals</a>

                </div>
                <div className='flex flex-row justify-center items-center gap-2'>
                    <FaGlobe color="rgb(88 28 135)" />
                    <a className=' cursor-pointer transition-all duration-200 border-b-2 hover:border-purple-950 '>Discover</a>

                </div>
                <div className='flex flex-row justify-center items-center gap-2'>
                    <img src={rrimage} width={50} height={50} className='rounded-full border-2 transition-all duration-500 hover:border-purple-900  ' />
                    <a className=' cursor-pointer transition-all duration-200 border-b-2 hover:border-purple-950 '>Raymond Reddington</a>
                </div>
            </div>
        </div >
    )
